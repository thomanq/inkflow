  ...
  return (
    <div className='homepage'>
      ...
      <p className='intro'>
        ...
        I made it to practice react and I wanted to import my own books. Let me know if
        you liked this or not. Feedbacks are always welcomed :D send feedbacks to me on
        discord at @doctorthe113.
      </p>
      <p className='text'>
        <div className='centered'>
          <hr />
          To begin click on keyboard icon on the navbar. <hr />
        </div>
        <br />
        <br />
        {/* <u>Instuctions,</u> */}
